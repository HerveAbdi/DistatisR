...
#' of the package \code{DistatisR}. Four algorithms evaluate the similarity
#' (i.e., distance) between six faces (3 females and 3 males). Each algorithm
#' provides a \eqn{6\times 6}{6*6} distance matrix evaluating the distance
...
#' @source Abdi et al. (2005). \url{www.utdallas.edu/~herve}
#' @author Herve Abdi
